...
def BMW() -> rx.Component:
    ...
    return rx.box( # Contenedor con imagen de fondo y overlay degradado
                    ...
                    rx.hstack( # Columna izquierda con textos y botones
                                rx.vstack(
                                            rx.heading(  "BMW i EL PRIMER BMW iX2. 100% ELÉCTRICO.",
                                                          size="8",
                                                          color="white",
                                                        ),
                                            
                                            rx.text(  "Desde 299 € al mes.",
                                                      size="8",
                                                      color="white",
                                                      margin_top="1rem"
                                            ...
                                            rx.text(  "Entrada: 10.447,30 €. Cuota final: 28.777,03 €*",
                                                      size="8",
                                                      color="white"
                                                    
                                                    ),
                            
                                            rx.text(  "Financiando con BMW Bank.",
                                                      size="8",
                                                      color="white"
                                                    
                                                    ),
                                        
                                            rx.text(  "Mantenimiento incluido",
                                                      size="8",
                                                      color="white",
                                                      margin_bottom="2rem"
